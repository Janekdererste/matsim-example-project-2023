...
public class CountActivities {
    ...
    public static void main(String[] args) {
        ...
        var population = PopulationUtils.readPopulation("C:\\Users\\janek\\Downloads\\berlin-v5.5.3-1pct.output_plans.xml.gz");
        var features = ShapeFileReader.getAllFeatures("C:\\Users\\janek\\Downloads\\Bezirke_-_Berlin\\Berlin_Bezirke.shp");
